...
class turtleBotThingieClass:
    def __init__(self):
        ...
        rospy.init_node("turtle_controller2")
    ...
    def mover(self):
        ...
        # initialising some pid_output values
        ...
        # setting the angle to face the destination directly
        while abs(self.angle_steer_error(final_destination)) >= error_tolerance and not rospy.is_shutdown():
            # PID feedback loop
        ...
        # moving towards the destination linearly
        while self.position_error(final_destination) >= error_tolerance and not rospy.is_shutdown():
            ...
            # adding steer control in case of small angle error due to large distance
            pid_output.angular.z = control_constants[1]*self.angle_steer_error(final_destination)
        ...
        # changing direction to face the final angle
